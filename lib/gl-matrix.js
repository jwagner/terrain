 ...
 *
 * @param {vec3} vec vec3 to calculate the square of the length of
 *
 * @returns {number} Length of vec squared
 */
 ...
 * Any javascript array-like objects containing at least 4 numeric elements can serve as a vec4
 *
 * @param {vec4} [vec] vec4 containing values to initialize with
 *
